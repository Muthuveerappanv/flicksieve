...
export default function OttTracker({ 
  ...
  // Filter scraped shows based on user preference toggles
  ...
  }, [scrapedShows, showAllLanguages, showNonPreferredGenres]);

  // Filter shows that have valid release dates
  ...
  return (
    <div className="tracker-container">
      {/* 91mobiles OTT Release Tracker Header Banner */}
      <div className="tracker-banner">
        <div className="banner-content">
          <h2>Weekly OTT Release Tracker</h2>
          <p>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', alignItems: 'center' }}>
          ...
          <div style={{ position: 'relative' }}>
            ...
            <input 
              type="text" 
              placeholder="Search weekly releases..." 
